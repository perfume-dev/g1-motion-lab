...
The checked-in [pose report](../data/reference/pose_retarget_qa.json) contains exact metrics, thresholds,
source/reference hashes, and calibration assumptions; [provenance](../data/reference/provenance.json) pins
