...
The canonical [`pose_retarget_qa.json`](../../../data/reference/pose_retarget_qa.json)
contains exact metrics, thresholds, source/reference hashes, and calibration
assumptions; [`provenance.json`](../../../data/reference/provenance.json) pins
