...
def main():
    ...
    write_json(args.output / 'provenance.json', {'model_repository': 'google-deepmind/mujoco_menagerie',
        ...
        'source_repository': 'perfume-dev/g1-motion-lab', 'source_path': 'data/source',
        'source_origin_repository': 'perfume-dev/example-openFrameworks',
        'source_origin_commit': '71c0a6363a5f504aa3ecc190fcd3067b3fc2fadf',
        'source_origin_path': 'example-bvh/bin/data',
